...
> ⚠️ **Перед публічним деплоєм:** увімкнути назад **Confirm email** (зараз вимкнено для
> зручності розробки) і налаштувати власний **SMTP** — вбудований мейлер Supabase для
> проду лімітований. Інакше можна реєструватись із чужою/неіснуючою поштою.
